# Original code is at https://github.com/lydiaMyr/ImmuCellAI/blob/main/R/ImmuCellAI.R
# This code is a modified version to work with custom sigature and remove NA from exp_new
# LICENSE: GPL
...
Sample_abundance_calculation = function(sample,paper_marker,marker_exp,data_type,customer){
  ...
  #remove NA from exp_new
  exp_new = exp_new[!is.na(rowSums(exp_new)),]
